...
> Symlinked from the central `team-harness` repo. To edit this file, edit `contexts/{{REPO_NAME}}/CLAUDE.md` in the central repo, not here. Local edits will affect the central repo (the symlink resolves there) and will silently propagate to every business repo that shares this slug.
...
|---|---|---|---|
| `{{REPO_NAME}}` | (services) | (topics) | (topics) |
